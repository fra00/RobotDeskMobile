...
| `UserAttentionCentering` | Solo planner; non closed-loop |
...
- ~~Attention centering~~ — ogni turno vocale, scan se no face, closed loop 5 step, flip pan — `UserAttentionCentering`
